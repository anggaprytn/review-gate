...
const AI_FOOTER: &str = "[AI generated by ReviewGate]";
...
mod tests {
    use super::{
        build_summary_note_body, publish_summary_with, reviewgate_note_count,
        select_publish_target, summary_marker, truncate_note_body,
    };
    use crate::{
